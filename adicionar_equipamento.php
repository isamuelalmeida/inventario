...
if(isset($_POST['add_equipment'])){
 ...
 if(empty($errors)){
	...
	$query .=" tombo,specifications,obs,types_equip_id,supplier_id,manufacturer_id,situation_id,created_by,created_at";
	$query .=") VALUES (";
	$query .=" '{$equip_tombo}', '{$equip_specifications}', '{$equip_obs}', '{$equip_type_equip}', '{$equip_supplier}', '{$equip_manufacturer}', '{$equip_situation}', '{$equip_created_by}','{$equip_created_at}'";
	$query .=")";
