     ...
     <div class="panel panel-default">
       <div class="panel-heading">
         <strong>
           ...
           <span>Editando <?php echo remove_junk(ucfirst($situation['name']));?></span>
        </strong>
       </div>
       <div class="panel-body">
         <form method="post" action="editar_situacao.php?id=<?php echo (int)$situation['id'];?>">
           <div class="form-group">
               <input type="text" class="form-control" name="situation-name" required value="<?php echo remove_junk(ucfirst($situation['name']));?>">
           </div>
