            ...
            <tbody>
              <?php foreach ($all_situations as $sit):?>
                <tr>
                    ...
                    <td><?php echo remove_junk(ucfirst($sit['name'])); ?></td>
                    <td class="text-center">
                      <div class="btn-group">
                        <a href="editar_situacao.php?id=<?php echo (int)$sit['id'];?>"  class="btn btn-xs btn-warning" data-toggle="tooltip" title="Editar">
                          <span class="glyphicon glyphicon-edit"></span>
                        </a>
                        <a href="deletar_situacao.php?id=<?php echo (int)$sit['id'];?>"  class="btn btn-xs btn-danger" data-toggle="tooltip" title="Remover">
