     ...
     <div class="panel panel-default">
       <div class="panel-heading">
         <strong>
           ...
           <span>Editando <?php echo remove_junk(ucfirst($type_equip['name']));?></span>
        </strong>
       </div>
       <div class="panel-body">
         <form method="post" action="editar_tipo_equipamento.php?id=<?php echo (int)$type_equip['id'];?>">
           <div class="form-group">
               <input type="text" class="form-control" name="type_equip-name" required value="<?php echo remove_junk(ucfirst($type_equip['name']));?>">
           </div>
